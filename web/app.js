...
(() => {
  ...
  function renderPage() {
    const page = $('#page');
    const renderers = { dashboard:renderDashboard, portfolio:renderPortfolio, dividends:renderDividends, calendar:renderCalendar, analytics:renderAnalytics };
  ...
  function init() {
    ...
    renderIcons();setupGlobalEvents();renderPage();showOnboarding();initPwa();scheduleEventNotifications();
