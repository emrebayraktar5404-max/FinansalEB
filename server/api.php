...
$config = is_file($configFile) ? require $configFile : [
    ...
    'USER_AGENT' => 'FinansalEB/0.3.15 (personal portfolio tracker)',
    'SEC_USER_AGENT' => '',
];
...
try {
    switch ($action) {
        ...
        case 'content':
            $data = cached('content_v15', 900, fn() => fetchContentBundle($config));
            respond(['ok' => true, 'data' => $data]);
            break;
...
function fetchContentBundle(array $config): array
{
    ...
    $queries = [
        ['q' => '(ekonomi OR borsa OR faiz OR enflasyon OR siyaset OR enerji OR savunma) Türkiye', 'source' => 'Türkiye gündemi', 'country'=>'Türkiye', 'category'=>'Ekonomi · siyaset'],
        ['q' => 'site:reuters.com (markets OR economy OR politics OR war OR energy)', 'source' => 'Reuters', 'country'=>'Küresel', 'category'=>'Küresel gündem'],
        ['q' => 'site:bbc.com/news (economy OR politics OR business OR conflict) UK', 'source' => 'BBC', 'country'=>'İngiltere', 'category'=>'Ekonomi · siyaset'],
        ['q' => '(site:apnews.com OR site:cnbc.com) (economy OR markets OR politics OR defense) US', 'source' => 'ABD kaynakları', 'country'=>'Amerika', 'category'=>'Piyasa · siyaset'],
        ['q' => '(site:ilsole24ore.com OR site:ansa.it) economia politica mercati', 'source' => 'İtalya kaynakları', 'country'=>'İtalya', 'category'=>'Ekonomi · siyaset'],
        ['q' => '(site:elpais.com OR site:expansion.com) economia politica mercados', 'source' => 'İspanya kaynakları', 'country'=>'İspanya', 'category'=>'Ekonomi · siyaset'],
        ['q' => '(site:tehrantimes.com OR site:iranintl.com) economy politics oil security', 'source' => 'İran kaynakları', 'country'=>'İran', 'category'=>'Enerji · jeopolitik'],
        ['q' => '(site:elfinanciero.com.mx OR site:eleconomista.com.mx) economia mercados politica', 'source' => 'Meksika kaynakları', 'country'=>'Meksika', 'category'=>'Ekonomi · piyasa'],
        ['q' => '(site:scmp.com OR site:caixinglobal.com) China economy markets politics trade', 'source' => 'Çin kaynakları', 'country'=>'Çin', 'category'=>'Ekonomi · ticaret'],
        ['q' => '(site:nikkei.com OR site:japantimes.co.jp) Japan economy markets politics', 'source' => 'Japonya kaynakları', 'country'=>'Japonya', 'category'=>'Ekonomi · piyasa'],
        ['q' => '(site:koreaherald.com OR site:koreatimes.co.kr) Korea economy markets politics', 'source' => 'Kore kaynakları', 'country'=>'Güney Kore', 'category'=>'Ekonomi · teknoloji'],
        ['q' => '(site:economictimes.indiatimes.com OR site:thehindu.com) India economy markets politics', 'source' => 'Hindistan kaynakları', 'country'=>'Hindistan', 'category'=>'Ekonomi · siyaset'],
        ['q' => '(site:lematin.ma OR site:medias24.com) Maroc economie politique', 'source' => 'Fas kaynakları', 'country'=>'Fas', 'category'=>'Ekonomi · siyaset'],
        ['q' => 'site:jordantimes.com Jordan economy politics regional security', 'source' => 'Jordan Times', 'country'=>'Ürdün', 'category'=>'Ekonomi · jeopolitik'],
        ['q' => '(site:arabnews.com OR site:alarabiya.net) Saudi economy oil politics security', 'source' => 'Suudi Arabistan kaynakları', 'country'=>'Suudi Arabistan', 'category'=>'Petrol · jeopolitik'],
    ];
